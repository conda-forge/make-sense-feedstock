...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/make-sense-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10405&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/make-sense-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `make-sense` can be installed with:

```
conda install make-sense
```

It is possible to list all of the versions of `make-sense` available on your platform with:
